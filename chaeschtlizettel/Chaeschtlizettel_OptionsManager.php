...
class Chaeschtlizettel_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'chaeschtlizettel'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'chaeschtlizettel'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'chaeschtlizettel'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'chaeschtlizettel'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'chaeschtlizettel');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'chaeschtlizettel'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'chaeschtlizettel');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'chaeschtlizettel') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'chaeschtlizettel');
            case 'false':
                return __('false', 'chaeschtlizettel');

            case 'Administrator':
                return __('Administrator', 'chaeschtlizettel');
            case 'Editor':
                return __('Editor', 'chaeschtlizettel');
            case 'Author':
                return __('Author', 'chaeschtlizettel');
            case 'Contributor':
                return __('Contributor', 'chaeschtlizettel');
            case 'Subscriber':
                return __('Subscriber', 'chaeschtlizettel');
            case 'Anyone':
                return __('Anyone', 'chaeschtlizettel');
        }
        return $optionValue;
    }
